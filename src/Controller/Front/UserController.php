...
class UserController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $passwordHasher, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($request->isMethod('POST')) {
            // Cast (string) — correction PHPStan
            $prenom        = (string) $request->request->get('firstname', '');
            $nom           = (string) $request->request->get('lastname', '');
            $email         = (string) $request->request->get('email', '');
            $plainPassword = (string) $request->request->get('password', '');
            $telephone     = (string) $request->request->get('telephone', '');
            $addresse      = (string) $request->request->get('addresse', '');
