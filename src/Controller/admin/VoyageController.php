...
class VoyageController extends AbstractController
{
    ...
    {
        if (empty($imageUrl)) {
            return '/images/default-voyage.jpg';
        }
        ...
        // Si le chemin commence par /uploads/ ou /images/
        if (preg_match('/^\/(uploads|images)\//', $imageUrl)) {
            return $imageUrl;
        }

        // Sinon, on suppose que c'est un nom de fichier dans uploads/voyages/
        return '/uploads/voyages/' . ltrim($imageUrl, '/');
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $imageUrl = $voyage->getImageUrl();
            if (!empty($imageUrl) && !preg_match('/^https?:\/\//', $imageUrl) && !preg_match('/^\//', $imageUrl)) {
                $voyage->setImageUrl('/uploads/voyages/' . ltrim($imageUrl, '/'));
            }
