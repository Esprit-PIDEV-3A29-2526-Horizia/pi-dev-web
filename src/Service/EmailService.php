...
class EmailService
{
    ...
    // ============================================================
    // MÉTHODES POUR LOCATION (véhicules) - appelées par ClientController
    // ============================================================
    ...
    /**
     * Envoie un email d'approbation d'annulation pour location
     * @return array<string, mixed>
     */
    public function sendCancellationApprovedEmailLocation(Location $location, string $emailClient): array
    {
        if (empty($emailClient)) {
            return ['succes' => false, 'message' => 'Adresse email du client manquante'];
        }
    ...
    /**
     * Envoie un email de refus d'annulation pour location
     * @return array<string, mixed>
     */
    public function sendCancellationRejectedEmailLocation(Location $location, string $emailClient): array
    {
        if (empty($emailClient)) {
            return ['succes' => false, 'message' => 'Adresse email du client manquante'];
        }
    ...
    // ============================================================
    // MÉTHODES POUR RÉSERVATION LOGEMENT - appelées par MesReservationslogController
    // ============================================================
    ...
    // ============================================================
    // MÉTHODES PRIVÉES POUR LOCATION
    // ============================================================
